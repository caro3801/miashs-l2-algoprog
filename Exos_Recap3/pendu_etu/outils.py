...
def lire_nombre():
    """ Lit un nombre saisi au clavier. Le type du résultat dépend de
...
def modif_chaine(ch, indice, par):
    """Renvoie une copie de ch, où le caractère à l'indice indiqué a été
    remplacé par le caractère par"""
    res = list(ch)
    res[indice] = par
    return ''.join(res)
