...
def saisie(mess, mini, maxi):
    """saisit un nombre qui devra être compris entre mini et maxi (compris) et renvoie ce nombre.
...
def date_ok(j, m, a):
    ...
    return (m == 1 or m == 3 or m == 5 or m == 7 or m == 8 or m == 10 or m == 12 and j <= 31) \
        or (m == 4 or m == 6 or m == 8 or m == 10 or m == 11 and j <= 30) \
        or (m == 2 and bissextile(a) and j <= 29) or (m == 2 and j <= 28)
